-- Redgate SQL Server Migration: Create comprehensive users table
...
BEGIN
    ...
    PRINT 'Redgate: Created users_comprehensive table successfully';
END
ELSE
BEGIN
    PRINT 'Redgate: Table users_comprehensive already exists';
END;
