-- Redgate SQL Server Migration: Create monitoring and audit system
...
BEGIN
    ...
    PRINT 'Redgate: Created audit_log table successfully';
END;
...
BEGIN
    ...
    PRINT 'Redgate: Created system_metrics table successfully';
END;
...
BEGIN
    ...
    PRINT 'Redgate: Created sp_audit_table_changes procedure successfully';
END;
