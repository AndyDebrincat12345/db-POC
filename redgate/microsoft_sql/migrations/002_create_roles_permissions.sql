-- Redgate SQL Server Migration: Create roles and permissions system
...
BEGIN
    ...
    PRINT 'Redgate: Created roles table successfully';
END;
...
BEGIN
    ...
    PRINT 'Redgate: Created permissions table successfully';
END;
...
BEGIN
    ...
    PRINT 'Redgate: Created role_permissions table successfully';
END;
...
BEGIN
    ...
    PRINT 'Redgate: Created user_roles table successfully';
END;
